...
class __TwigTemplate_1ba34508066e034f6370b419fce3e83ef3ca83c5c41d725a78ddb2a18a0244d7 extends Twig_Template
{
        ...
        if (twig_test_iterable((isset($context["value"]) ? $context["value"] : null))) {
            ...
            if (("show" == (isset($context["view"]) ? $context["view"] : null))) {
                ...
                ";
                    ...
                    $context['_seq'] = twig_ensure_traversable(twig_slice($this->env, (isset($context["value"]) ? $context["value"] : null), 0, $this->env->getExtension('easyadmin_extension')->getBackendConfiguration("show.max_results")));
                    foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                        ...
                        if (array_key_exists("link_parameters", $context)) {
                            // line 9
                            echo "                            ";
                            $context["primary_key_value"] = $this->getAttribute($context["item"], $this->getAttribute((isset($context["link_parameters"]) ? $context["link_parameters"] : null), "primary_key_name", array()));
                            // line 10
                            echo "                            <a href=\"";
                            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("easyadmin", twig_array_merge((isset($context["link_parameters"]) ? $context["link_parameters"] : null), array("id" => (isset($context["primary_key_value"]) ? $context["primary_key_value"] : null), "referer" => ""))), "html", null, true);
                            echo "\">";
                ...
                ";
                    // line 17
                    $context["_remaining_items"] = (twig_length_filter($this->env, (isset($context["value"]) ? $context["value"] : null)) - $this->env->getExtension('easyadmin_extension')->getBackendConfiguration("show.max_results"));
                    // line 18
                    echo "                ";
                    if (((isset($context["_remaining_items"]) ? $context["_remaining_items"] : null) > 0)) {
                        // line 19
                        echo "                    <li>(";
                        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->transchoice("show.remaining_items", (isset($context["_remaining_items"]) ? $context["_remaining_items"] : null), array(), "EasyAdminBundle"), "html", null, true);
                        echo ")</li>
                ";
                    }
                    // line 21
...
array_key_exists("link_parameters", $context)) {
            // line 32
            echo "    <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("easyadmin", twig_array_merge((isset($context["link_parameters"]) ? $context["link_parameters"] : null), array("referer" => ""))), "html", null, true);
            echo "\">";
